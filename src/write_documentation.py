...
from project_paths import DOCS_DIR, ECE_BINS, FIG_DIR, HIGH_CONFIDENCE_THRESHOLD, PILOT_DATA
...
"""
    ...
    data_manifest = [
        ...
        {"file_path": "outputs/ar_parsed_generations.jsonl", "description": "AR parsed generations", "row_count": sum(1 for row in rows if row["model_family"] == "AR")},
        ...
        {"file_path": "dlm_outputs/dlm_parsed_generations.jsonl", "description": "DLM parsed generations", "row_count": sum(1 for row in rows if row["model_family"] == "DLM")},
    ]
...
def produce_manifest() -> None:
    definitions = [
        ...
        ("fig_tabs/figure_1_reliability_diagram_data.csv", "figure_data", "Reliability diagram plotted values", "Results", True, True),
        ...
        ("fig_tabs/figure_2_confidence_by_correctness_data.csv", "figure_data", "Confidence distribution plotted values", "Results", True, True),
        ...
        ("fig_tabs/figure_2_2_confidence_by_correctness_neutral_data.csv", "figure_data", "Neutral-prompt confidence distribution plotted values", "Results", True, True),
        ...
        ("fig_tabs/figure_3_prompt_sensitivity_data.csv", "figure_data", "Prompt sensitivity plotted values", "Results", True, True),
        ...
        ("src/prepare_review_artifact.py", "code", "Artifact generation driver", "Artifact", True, True),
        ("src/check_review_artifacts.py", "code", "Artifact validation script", "Artifact", True, True),
        ("src/load_generation_data.py", "code", "Data loading and alignment helpers", "Artifact", True, True),
        ("src/write_documentation.py", "code", "Documentation and manifest helpers", "Artifact", True, True),
        ("src/render_figures.py", "code", "Figure rendering and plotted-data helpers", "Artifact", True, True),
        ("src/grade_answers.py", "code", "Deterministic grading helpers", "Artifact", True, True),
        ("src/file_io.py", "code", "CSV and JSONL helpers", "Artifact", True, True),
        ("src/compute_metrics.py", "code", "Metric formula helpers", "Artifact", True, True),
        ("src/project_paths.py", "code", "Shared paths and constants", "Artifact", True, True),
        ("src/write_tables.py", "code", "Table and audit helpers", "Artifact", True, True),
    ]
    rows = [
        {
            "file_path": file_path,
