...
Comparative metric tables and figures use the shared AR/DLM question-ID intersection (247 questions). Source-level exclusions are listed in `metrics/data_alignment_exclusions.csv`.
