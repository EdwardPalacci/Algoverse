...
# Make local analysis helpers importable whether this file is run as a script or cell-by-cell.
...
_GRADED_RESULTS = REPO_ROOT / "ar_models" / "model_outputs" / "ar_graded_generations.jsonl"
_PARSED_RESULTS = REPO_ROOT / "ar_models" / "model_outputs" / "ar_parsed_generations.jsonl"
...
# Keep raw JSONL artifacts under the model folders and paper-facing tables/figures
# under paper_assets/.
FIGURES_DIR = REPO_ROOT / "paper_assets" / "figures"
ARTIFACTS_DIR = REPO_ROOT / "paper_assets" / "tables"
...
# %% [markdown]
# ## Persist artifacts under paper_assets/tables/
